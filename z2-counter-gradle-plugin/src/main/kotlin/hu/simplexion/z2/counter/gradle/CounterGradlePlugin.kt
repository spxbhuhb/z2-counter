...
@Suppress("unused")
class CounterGradlePlugin : KotlinCompilerPluginSupportPlugin {

    override fun apply(target: Project): Unit = with(target) {
        extensions.create(GRADLE_EXTENSION_NAME, CounterGradleExtension::class.java)
    }

    override fun isApplicable(kotlinCompilation: KotlinCompilation<*>): Boolean =
        kotlinCompilation.target.project.plugins.hasPlugin(CounterGradlePlugin::class.java)
...
//        }
        ...
        val extension = project.extensions.getByType(CounterGradleExtension::class.java)
